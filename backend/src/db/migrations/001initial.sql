...
-- Churn risk detection index (active members only)
...
-- Composite index for live occupancy query (most frequent query)
...
CREATE INDEX idx_anomalies_active ON anomalies(gym_id, detected_at DESC)
WHERE resolved = FALSE;

-- ============================================
-- MATERIALIZED VIEW: Hourly Stats for Peak Hours
-- ============================================
